...
演示如何使用已优化的Expert池进行医疗Diagnosis
"""
...
def example_basic_diagnosis():
    ...
    print("="*70)
    print("示例：使用可演化Expert池进行Diagnosis")
    print("="*70)
    
    # 1. 初始化Diagnosis流水线
    print("\n[1] 初始化Diagnosis流水线...")
    pipeline = DiagnosticPipeline(
        activation_mode="eep_semantic",  # 使用可演化Expert池
    ...
    patient = PatientInfo(
        ...
        diagnosis=""  # 待Diagnosis
    )
    
    # 3. 执行Diagnosis
    print("\n[3] 执行Diagnosis流程...")
    print("  - Step 1: Department路由")
    print("  - Step 2: 信息重构")
    print("  - Step 3: ExpertDiagnosis")
    print("  - Step 4: 结果聚合")
